...
public final class Endpoints {
    public final static String EpisodeInfo = "api/content/episode/front/{id}";
    public final static String PPV_EpisodeInfo = "api/v1/content/info/episode/{id}";
    public final static String AUTH = "api/usermanagement/auth";
